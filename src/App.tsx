...
import { faCheckSquare, faCoffee, faPlay, faPause, faCog } from '@fortawesome/free-solid-svg-icons'
import Timer from './component/Timer';
import HomeScreen from './component/HomeScreen';

library.add(faCheckSquare, faCoffee, faPlay, faPause, faCog);
...
function App() {
  ...
  return (
    <div className="App">
      {currentScreen === "home" && <HomeScreen setupFor="" title="Home" timeColor="white" onChangeScreen={(screen: string) => handleOnChangeScreen(screen)} />}
      ...
      {currentScreen === "timer" && <HomeScreen hour={hour} minute={minute} second={second} />}
    </div>
